...
class TypeConsultationController extends AbstractController
{
    ...
    /**
     * @Route("/{id}", name="app_type_consultation_show", methods={"GET"}, requirements={"id":"\d+"})
     */
    ...
    /**
     * @Route("/{id}/edit", name="app_type_consultation_edit", methods={"GET", "POST"}, requirements={"id":"\d+"})
     */
    ...
    /**
     * @Route("/{id}", name="app_type_consultation_delete", methods={"POST"}, requirements={"id":"\d+"})
     */
